                ...
                {(() => {
                    if (props.title === "Total Device") {
                        return <div class="card-body">
                            <div class="media d-flex">
                                <div class="media-body text-left">
                                    <h3 class={clrCount}>{props.stb + props.ott}<div style={{ fontSize: '75%' }}>STB({props.stb}), OTT({props.ott})</div></h3>
                                </div>
                                <div>
                                    <i class={cls}></i>
                                </div>
                        ...
                        return <div class="card-body">
                            <div class="media d-flex">
                                <div class="media-body text-left">
                                    <h3 class={clrCount}>{props.count + props.ott}<div style={{ fontSize: '75%' }}>STB({props.count}),  OTT({props.ott}) </div></h3>
                                </div>
                                <div>
                                    <i class={cls}></i>
                                </div>
