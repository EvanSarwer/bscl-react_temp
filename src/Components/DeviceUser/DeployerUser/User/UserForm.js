...
const UserForm = (props) => {
    ...
    useEffect(() => {
        setUsername(props.device_id +"_"+ (parseInt(props.user_index)+1));
                                            ...
                                            <table class="table table-borderless">
                                                <tr>
                                                    ...
                                                    <td><fieldset className="form-group position-relative has-icon-left">
                                                        <input type="text" name="user_name" id="user_name" value={user_name} onChange={(e) => { setUsername(e.target.value) }} readOnly className="form-control" placeholder="Username" tabIndex={1} required data-validation-required-message="Please enter username." />
